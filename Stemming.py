...
# stop words are the ones that do not put much value to the task at hand like of, the , a and hence they are removed
# stopwords.words('english')


for i in range(len(sentences)):
    words = nltk.word_tokenize(sentences[i])
    # used set so that only unique words used
